...
namespace ConectaAtende.Benchmarks.TestHelpers;

/// <summary>
/// Repositório simplificado para benchmarks (em memória para performance).
/// </summary>
public class BenchmarkContactRepository : IContactRepository
{
